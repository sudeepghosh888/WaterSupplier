...
<html lang="en">
  <head>
    ...
    <title>Admin Panel | Water Supply</title>
     <%@ include file="AdminDashboard/AdminView/header.jsp" %>
  ...
  <body class="login">
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
         ...
         <script src="/AdminDashboard/vendors/jquery/dist/jquery.min.js"></script>
     
         <script src="/AdminDashboard/vendors/sweetalert2/sweetalert2.min.js"></script>
     
         <script src="/AdminDashboard/js/notify.min.js"></script>
